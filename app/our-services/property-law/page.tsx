...
export const metadata: Metadata = {
  title: "Property Law | Mathe Rodrick Attorneys Inc",
  description: "Mathe Rodrick Attorneys Inc provides expert legal services in Property Law, real estate transactions, eviction disputes, and property litigation in Johannesburg and Gauteng.",
}

const propertyLawAreas = [
...
const rentalAndEvictionServices = [
  {
    num: "01",
    title: "Lease Agreements",
    description: "Drafting legally sound residential and commercial lease agreements to protect your property rights and prevent future disputes."
  },
  {
    num: "02",
    title: "Rental Arrears Collections",
    description: "Managing rental arrears collections and pursuing lawful recovery of outstanding monies with professional efficiency."
  },
  {
    num: "03",
    title: "Lawful Eviction Applications",
    description: "Navigating lawful eviction applications in strict compliance with the Prevention of Illegal Eviction from and Unlawful Occupation of Land Act."
  }
]
  ...
  return (
    <div className="flex min-h-screen flex-col bg-background">
      ...
      <main className="flex-1">
          ...
          <div className="relative z-10 grid w-full gap-12 px-5 py-24 lg:grid-cols-12 md:px-8 md:py-32">
            ...
            <div className="flex items-end lg:col-span-7">
              <p className="border-l border-white/20 pl-6 text-base font-normal leading-relaxed text-white/80 md:text-lg">
                Respectfully guiding clients through complex property transfers, challenging eviction disputes, and intricate real estate contracts with personalised and efficient legal service.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="border-b border-foreground">
          <div className="grid w-full gap-12 px-5 py-20 lg:grid-cols-12 md:px-8 md:py-28">
            ...
            <div className="space-y-6 text-base font-normal leading-relaxed text-muted-foreground lg:col-span-8 md:text-lg">
              <p>
                Mathe Rodrick Attorneys Inc is an established and experienced law firm in Johannesburg, deeply committed to ethical legal practices. We understand that property transactions and disputes involve significant financial investments and deep personal attachments.
              </p>
              <p>
                Our dedicated team of lawyers provides a personalised and efficient legal service to property owners, tenants, buyers, and developers across Gauteng. We have the necessary experience to respectfully guide our clients through complex property transfers, challenging eviction disputes, and intricate real estate contracts.
              </p>
        ...
        {/* Real Estate and Property Transactions (Split Layout) */}
        <section className="border-b border-foreground bg-foreground/[0.02]">
          <div className="grid w-full gap-0 lg:grid-cols-2">
            <div className="border-b border-foreground p-5 py-20 lg:border-b-0 lg:border-r md:p-12 lg:p-20">
              <p className="text-sm font-bold uppercase tracking-widest text-muted-foreground">Real Estate</p>
              ...
              <p className="mt-6 text-base font-normal leading-relaxed text-muted-foreground">
                Property is often your most valuable asset, and navigating the legalities of ownership requires meticulous attention to detail. We tailor our legal approach to protect your property rights and ensure seamless transactions under South African property legislation.
              </p>
            </div>
        ...
        {/* Evictions and Rental Disputes (Centered Emphasis) */}
        <section className="border-b border-foreground">
          <div className="flex flex-col items-center text-center px-5 py-20 md:px-8 md:py-32">
            <p className="text-sm font-bold uppercase tracking-widest text-muted-foreground">Landlord & Tenant</p>
            ...
            <div className="mt-8 max-w-2xl space-y-6 text-base font-normal leading-relaxed text-muted-foreground md:text-lg">
              <p>
                Disputes between landlords and tenants can become highly contentious and legally stressful. Our firm provides compassionate and highly efficient legal assistance for all rental and eviction matters.
              </p>
              <p>
                We manage the legal complexities so you can achieve a fair and lawful resolution in strict compliance with South African legislation.
              </p>
            </div>
          </div>
        </section>

        {/* Comprehensive Rental & Eviction Services (Structured Grid) */}
        <section className="border-b border-foreground bg-foreground/[0.02]">
          <div className="grid w-full gap-0 lg:grid-cols-12">
            <div className="border-b border-foreground p-5 py-20 lg:col-span-4 lg:border-b-0 lg:border-r md:p-8 lg:p-12 xl:p-16">
              ...
              <h2 className="mt-4 text-3xl sm:text-4xl lg:text-3xl xl:text-4xl 2xl:text-5xl font-normal uppercase leading-tight tracking-normal break-words">
                Our Rental & Eviction Practice Areas
              </h2>
              <p className="mt-6 text-base font-normal leading-relaxed text-muted-foreground">
                Our comprehensive practice areas cover every stage of the rental relationship to safeguard your rights and investments.
              </p>
            </div>
            
            <div className="lg:col-span-8">
              <div className="grid grid-cols-1 gap-0 sm:grid-cols-3">
                {rentalAndEvictionServices.map((service, index) => {
                  const isLastItem = index === rentalAndEvictionServices.length - 1
        ...
        {/* Resolving Property Disputes (Card Layout) */}
        <section className="border-b border-foreground">
          <div className="w-full px-5 py-20 md:px-8 md:py-28">
            <div className="mb-16 max-w-3xl">
              ...
              <p className="mt-6 text-base font-normal leading-relaxed text-muted-foreground md:text-lg">
                We use the legal methods most appropriate for your specific real estate circumstances, paying particular attention to the level of conflict, complexity, and urgency involved in your matter.
              </p>
            </div>
            ...
            <div className="grid w-full gap-8 md:grid-cols-2">
              <div className="flex flex-col border border-foreground p-8 lg:p-12 bg-background transition-all duration-300 hover:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] dark:hover:shadow-[8px_8px_0px_0px_rgba(255,255,255,1)]">
                ...
                <p className="mt-4 text-base font-normal leading-relaxed text-muted-foreground">
                  We prioritise efficient resolutions through formal negotiation and mediation. These methods are highly effective for resolving boundary disputes, sectional title disagreements, and lease issues without the excessive cost and delay of litigation.
                </p>
              </div>
              ...
              <div className="flex flex-col border border-foreground p-8 lg:p-12 bg-background transition-all duration-300 hover:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] dark:hover:shadow-[8px_8px_0px_0px_rgba(255,255,255,1)]">
                ...
                <p className="mt-4 text-base font-normal leading-relaxed text-muted-foreground">
                  When an out of court settlement is not viable, we provide formidable formal representation in the Magistrate Courts and High Courts. We vigorously advocate for your property rights to ensure your investments and your dignity are fully protected.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="border-b border-foreground">
          <div className="flex w-full flex-col items-start gap-8 px-5 py-20 lg:flex-row lg:items-center lg:justify-between md:px-8 md:py-28">
            <div className="max-w-2xl flex-1 min-w-0">
              ...
              <h2 className="mt-4 text-3xl sm:text-4xl lg:text-4xl xl:text-5xl font-normal uppercase leading-tight tracking-normal break-words">
                Principled Counsel For Your Property
              </h2>
              <p className="mt-6 text-base font-normal leading-relaxed text-muted-foreground">
                Whether you are purchasing your first family home, managing a commercial property portfolio, or navigating a complex eviction process, we are here to provide clear, honest, and effective legal support.
              </p>
            </div>
